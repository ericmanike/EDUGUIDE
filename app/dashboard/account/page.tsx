...
export default function AccountPage() {
  ...
  const [jwtClaims, setJwtClaims] = useState<JwtTokenPayload | null>(null);
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="flex items-center gap-1 text-[10px] font-bold text-emerald-400">
                  <CheckCircle2 className="w-3 h-3" /> Active JWT Session
                </span>
              </div>
            ...
            <form onSubmit={handleUpdateProfile} className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <div className="relative flex items-center">
                    <Shield className="w-4 h-4 absolute left-3.5 text-slate-400" />
                    <select
                      value={role}
            ...
            <div className="space-y-3.5 text-xs">
              ...
              <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-100 space-y-1">
                ...
                <p className="font-semibold text-emerald-600 flex items-center gap-1">
                  ...
                  {formatTimestamp(jwtClaims?.exp)}
                </p>
              </div>
            </div>

            <div className="p-4 rounded-xl bg-blue-50/70 border border-blue-100 text-slate-600 text-xs space-y-1">
              <p className="font-bold text-[#1e3a8a] flex items-center gap-1.5">
                <Sparkles className="w-3.5 h-3.5 text-[#fb923c]" />
                Cookie Security Active
              </p>
              <p className="text-[11px] text-slate-500 leading-relaxed">
                Your authentication token is stored safely in HTTP cookies (`token`) with 24-hour expiration.
              </p>
            </div>
          </div>
        </div>
